...
class Department extends Base {
	...
	async createDepartment(department) {
		...
		const res = await this.curl('https://qyapi.weixin.qq.com/cgi-bin/department/create', 'POST', department, 'agent');
		return res;
	}
	...
	async updateDepartment(department) {
		...
		const res = await this.curl('https://qyapi.weixin.qq.com/cgi-bin/department/update', 'POST', department, 'agent');
		return res;
	}
	...
	async deleteDepartment(id) {
		...
		const res = await this.curl(`https://qyapi.weixin.qq.com/cgi-bin/department/delete`, 'GET', {
			id
		}, 'agent');
		return res;
	}
	...
	async listDepartment(id) {
		...
		const res = await this.curl(url, 'GET', {id}, 'agent');
		return res;
	}
	...
	async getDepartment(id) {
		...
		// 构建请求URL
		const url = `https://qyapi.weixin.qq.com/cgi-bin/department/get`;
